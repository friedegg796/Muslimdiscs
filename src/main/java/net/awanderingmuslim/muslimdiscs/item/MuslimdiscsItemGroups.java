...
public class MuslimdiscsItemGroups {
    public static final ItemGroup MUSLIMDISCS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(MuslimdiscsItems.EID_TAKBIR_MUSIC_DISC))
                    .displayName(Text.translatable("itemgroup.muslimdiscs.muslimdiscs"))
                    .entries((displayContext, entries) -> {
                        entries.add(MuslimdiscsItems.EID_TAKBIR_MUSIC_DISC);
